...
| `/sportsbook/light` | White Caelo chrome (preview page) | `caelo-palette.css` + `caelo-light.css` |

Light preview reuses the home layout HTML. Do not replace the dark home page.
