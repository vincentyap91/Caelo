...
const REPLACEMENTS = [
  ...
  ['hover:text-white', 'hover:text-[var(--color-text-card-text)]'],

  // white / black solids
  ['bg-transparent', 'bg-transparent'],
  ['text-white', 'text-[var(--color-text-card-text)]'],
  ...
  ['bg-blue-800', 'bg-[var(--color-button-hover)]'],
  ...
  ['from-white', 'from-[var(--color-surface-base)]'],
  ['via-white', 'via-[var(--color-surface-base)]'],
  ['to-white', 'to-[var(--color-surface-base)]'],
  ...
  ['hover:bg-[#0d2a6a]', 'hover:bg-[var(--color-button-hover)]'],
