...
const REPLACEMENTS = [
  ...
  ['--color-gradient-vip-nav-pill-hover', '--color-gradient-side-menu-brand'],
  ['--color-gradient-vip-nav-pill', '--color-gradient-side-menu-brand'],
  ['--color-gradient-language-nav', '--color-gradient-side-menu-brand'],
  ...
  ['--color-gradient-accent-tab', '--color-gradient-side-menu-brand'],
  ...
  ['--color-gradient-language-option-active', '--color-gradient-side-menu-brand'],
  ...
  ['--color-gradient-footer', '--color-gradient-side-menu-brand'],
  ['--color-gradient-floating-social', '--color-gradient-side-menu-brand'],
