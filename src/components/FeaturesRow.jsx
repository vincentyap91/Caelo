        ...
        <section className="home-features-section w-full pt-8">
            ...
            <div className="mt-8 grid grid-cols-2 items-stretch gap-3.5 px-4 sm:gap-4 lg:flex lg:items-center lg:justify-between lg:gap-4">
                {features.map((item, idx) => (
                    <div
                        key={idx}
                        className="group flex h-full min-h-[7.5rem] min-w-0 flex-col items-center justify-center gap-2.5 rounded-xl border border-[var(--color-border-brand)] bg-[var(--color-tertiery)]/40 px-3 py-4 text-center shadow-[0_5px_15px_rgba(0,174,239,0.05)] transition-transform hover:-translate-y-1 sm:gap-3 sm:px-3.5 sm:py-[1.125rem] lg:min-h-0 lg:min-w-[200px] lg:flex-1 lg:flex-row lg:items-center lg:justify-center lg:gap-3 lg:px-4 lg:py-3 lg:text-left"
                    >
                        <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full border border-[var(--color-surface-cool-light)] bg-[var(--color-tertiery)] p-1 shadow-sm transition-transform group-hover:scale-110 lg:h-auto lg:w-auto lg:p-2">
                            {item.icon}
                        </div>
