...
export default function ProviderLobbyTile({
    ...
    return (
        ...
        >
            ...
            <div className="provider-lobby-card__label flex min-h-[40px] items-center justify-center border-t border-[var(--color-border-subtle)] bg-[var(--color-surface-input-light)] px-2 py-2">
