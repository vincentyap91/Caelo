...
const DEFAULT_CLASS =
    'btn-theme-cta inline-flex h-10 min-w-[100px] flex-1 items-center justify-center rounded-xl px-5 text-sm font-bold shadow-[0_6px_14px_rgba(242,154,0,0.28)] transition hover:-translate-y-0.5 hover:brightness-105';
