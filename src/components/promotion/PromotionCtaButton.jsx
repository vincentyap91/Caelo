...
const DEFAULT_CLASS =
    'btn-theme-cta inline-flex h-10 min-w-[100px] flex-1 items-center justify-center rounded-xl px-5 text-sm font-bold shadow-[var(--shadow-cta-soft)] transition hover:-translate-y-0.5 hover:brightness-105';
