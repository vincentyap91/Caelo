            ...
            >
                ...
                {!isFullscreen ? (
                    <button
                        ...
                        className="absolute bottom-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-lg border border-[var(--color-nav-border)]/20 bg-[var(--color-surface-darkest)]/50 text-[var(--color-text-card-text)] backdrop-blur-sm transition hover:bg-[var(--color-surface-darkest)]/70"
