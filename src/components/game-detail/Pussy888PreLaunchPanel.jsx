...
const inputClass =
    'w-full rounded-xl border border-[var(--color-border-subtle)]/90 bg-[var(--color-surface-input-light)] px-3.5 py-2.5 text-sm font-semibold text-[var(--color-text-primary)] shadow-[var(--inset-panel)] outline-none ring-[var(--color-accent)] focus-visible:ring-2';
