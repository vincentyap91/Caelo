...
export default function GameDetailPlayModal({
    ...
    return createPortal(
        ...
        >
            <header className="flex shrink-0 items-center justify-between gap-3 border-b border-[var(--color-nav-border)] bg-[var(--color-primary)] px-4 py-3 pt-[max(0.75rem,env(safe-area-inset-top))] shadow-[var(--inset-highlight-soft)]">
                ...
                <button
                    ...
                    className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-[var(--color-nav-border)]/25 bg-[var(--color-nav-border-soft)] text-[var(--color-text-card-text)] transition hover:bg-[var(--color-surface-base)]/18 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/60"
                >
