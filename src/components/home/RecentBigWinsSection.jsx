...
function WinRow({ item }) {
    ...
    return (
        <li className="border-b border-[var(--color-border-subtle)]/90 py-3.5 sm:py-4 md:py-[18px]">
            <div className="flex gap-2.5 max-sm:items-start sm:gap-3 md:gap-4">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3 md:gap-4">
                    <div className="min-w-0 flex-1 pr-0.5">
                        <span
                            title={badge}
                            className="inline-flex max-w-full rounded-md bg-[var(--color-surface-muted)] px-1.5 py-0.5 text-xs font-bold uppercase leading-snug tracking-wide text-[var(--color-text-subtle)] ring-1 ring-[var(--color-border-subtle)]/80 sm:px-2 sm:leading-normal"
                        >
                    ...
                    <div className="flex min-w-0 shrink-0 flex-col items-end gap-0.5 self-center text-right sm:gap-1">
                        <span className="break-words text-right text-xs font-bold tabular-nums leading-tight tracking-tight text-[var(--color-button-hover)] sm:text-base sm:leading-none">
                            {item.amount}
                        </span>
                        <span className="flex max-w-[7.5rem] items-center justify-end gap-0.5 text-xs font-medium leading-none text-[var(--color-button-hover)] sm:max-w-none sm:gap-1">
