...
export const ADVANCED_GROUPS = [
  ...
  },
  {
    ...
    variables: [
      ...
      { label: 'Footer Gradient', variable: '--color-gradient-menu-brand', defaultValue: 'linear-gradient(180deg, #123B94 0%, #123B94 100%)' },
      { label: 'Menu Brand Gradient', variable: '--color-gradient-menu-brand', defaultValue: 'linear-gradient(180deg, #123B94 0%, #01206C 100%)' },
