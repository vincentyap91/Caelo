...
function Avatar({ small = false }) {
    return (
        <span
            className={`inline-flex shrink-0 overflow-hidden rounded-full border border-[var(--color-accent-500)]/22 bg-[var(--color-surface-base)] shadow-[var(--shadow-brand-soft)] ${small ? 'h-10 w-10' : 'h-12 w-12'
                }`}
        >
            <img
        ...
        <>
            <div className="relative flex shrink-0 items-center justify-between px-6 pb-6 pt-7">
                ...
                <button
                    ...
                    aria-label="Close"
                    onClick={onClose}
                    className="inline-flex h-8 w-8 items-center justify-center rounded-full text-[var(--color-text-secondary)] transition hover:bg-[var(--color-brand-soft)]"
                >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-5 pb-5">
                <div className="rounded-[24px] border border-[var(--color-border-brand)] bg-gradient-register-panel px-5 pb-6 pt-7 shadow-[var(--inset-panel)]">
                    <div className="border-b border-[var(--color-border-accent)] pb-5">
                    ...
                    <div className="mt-5 space-y-3.5">
                        ...
                        >
                            ...
                            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[var(--color-brand-soft)] text-[var(--color-primary)]">
                                <Send size={16} />
                            </span>
                        </button>
            ...
            <div className="shrink-0 border-b border-[var(--color-border-brand)] bg-gradient-register-panel px-5 py-3.5">
                <div className="flex items-start gap-3">
                    <button
                        ...
                        className="mt-1 inline-flex h-8 w-8 items-center justify-center rounded-full text-[var(--color-text-secondary)] transition hover:bg-[var(--color-brand-soft)]"
                    >
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="inline-flex h-2 w-2 rounded-full bg-[var(--color-accent-400)]" />
