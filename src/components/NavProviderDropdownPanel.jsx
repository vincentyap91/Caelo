...
export default function NavProviderDropdownPanel({ open = false, providers = [], onProviderClick }) {
    ...
    return (
        <section className="absolute left-1/2 top-full z-[90] w-screen -translate-x-1/2 border-t border-[rgb(26_59_114)]">
                    ...
                    {providers.map((provider) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {provider.hot ? (
                                    <span className="absolute right-2 top-2 rounded-full bg-[var(--color-hot-main)] px-2 py-0.5 text-xs font-bold tracking-wide text-white shadow-[0_4px_10px_rgba(255,77,0,0.4)]">
                                        HOT
                                    </span>
                                ) : null}
                            </button>
