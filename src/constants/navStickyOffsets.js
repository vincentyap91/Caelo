 ...
 * - Mobile / tablet: one row (`MobileSiteHeader` min-h 56px) — matches `App` main `pt-14`.
 * - lg+: dark strip (36px) + main nav (64px) = 100px.
 */
export const NAV_STICKY_SUBHEADER_TOP_CLASS = 'top-14 lg:top-[100px]';
